...
function shuffleWords(words, id = 1) {
...
function renderAnswer() {
  ...
  answer.forEach((word) => {
    ...
    el.style.opacity = 0; // Ẩn từ trong dropzone
...
document.onmousedown = handleMouseDown; // Sự kiện bấm chuột
document.onmouseup = handleMouseUp; // Sự kiện thả chuột
document.onmousemove = handleMouseMove; // Sự kiện di chuyển chuột
